...
import 'package:test_effective/src/presentation/shared/favorite_dismissible.dart';
...
class CharacterCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FavoriteDismissible(
      addToFavorites: () {
        BlocProvider.of<CharactersBloc>(context).add(CharactersEvt.addToFavorites(character.id));
      },
      removeFromFavorites: () {
        BlocProvider.of<CharactersBloc>(context).add(CharactersEvt.removeFromFavorites(character.id));
      },
      child: Card(
        child: Padding(
                      ...
                      children: [
                        ...
                        IconButton(
                          ...
                          onPressed: () {
                            ...
                            bloc.add(CharactersEvt.addToFavorites(character.id));
                            // bloc.add(FavoritesEvent.addToFavorite(character.id));
                          },
                        ),
                      ],
                    ),
